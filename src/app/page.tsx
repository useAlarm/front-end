...
export default async function Home() {
  ...
  return (
    <main className='flex w-full h-full justify-content-center align-items-center absolute left-0 top-0 flex-column gap-2 p-4'>
      ...
      <Suspense fallback={
        ...
        <h1 className='text-xl text-center md:text-2xl text-indigo-500 font-bold'>
      ...
      <Suspense fallback={
        ...
        <p className='text-center font-medium text-sm md:text-base mb-4'>
